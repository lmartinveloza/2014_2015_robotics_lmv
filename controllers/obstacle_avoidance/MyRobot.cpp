/**
 * @file    MyRobot.cpp
 * @brief   definition of all the code for the correct operation of the robot.
 *
...
MyRobot::MyRobot() : DifferentialWheels()
{
    ...
    //Asignation and activation of distance sensors
...
MyRobot::~MyRobot()
{
    //deactivation of all distance sensors
...
void MyRobot::run()
{
    ...
    while (step(_time_step) != -1) {
        ...
        if((ir12_val > DISTANCE_LIMIT+200)){
            _mode = OBSTACLE_AVOID1;
            cout << "MOVING BACK." << endl;
        }
